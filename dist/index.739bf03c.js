...
input.addEventListener("input", (0, _lodashDebounceDefault.default)(searchh, DEBOUNCE_DELAY));
function searchh() {
    const searchvalue = input.value.toLowerCase();
    exactCountry.innerHTML = "";
    list.innerHTML = "";
    if (searchvalue.length > 0) (0, _fetchCountries.fetchCountries)(searchvalue).then((countries)=>{
        console.log(countries);
        if (countries.length > 10) (0, _notiflixDefault.default).Notify.info("Too many matches found. Please enter a more specific name.");
        else if (countries.length >= 2 && countries.length < 10) makeCs(countries);
        else makeC(countries);
    }).catch((error)=>{
...
function makeC(countries) {
    const markup = countries.map((country)=>{
        return `
          ...
          <p style="font-weight: 700; margin-bottom: 30px">Languages: ${Object.values(country.languages)}</p>
...
},{"../css/styles.css":"1CY4s","lodash.debounce":"3JP5n","notiflix":"5WWYd","./fetchCountries":"dKuy9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
